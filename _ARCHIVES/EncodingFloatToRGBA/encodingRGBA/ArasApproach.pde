public static final double[] afactor = {1.0, 255.0, 65025.0, 16581375.0};
public static final double[] adfactor = {1.0, 1/255.0, 1/65025.0, 1/16581375.0};
public static final double[] aMask = {1.0/255.0, 1.0/255.0, 1.0/255.0, 0.0};


int afloatToARGB32(double value){
  double[] rgba = {
    afactor[0] * value,
    afactor[1] * value,
    afactor[2] * value,
...
double aARGB32Tofloat(int argb) {
  double[] rgbaArray = getRGBA(argb);
