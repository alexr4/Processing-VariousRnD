...
public final static double[] skefactor = {1, 255, 65025, 16581375};
public final static double[] skscale = {1.0, 256.0, 65536.0};
public final static double[] skdfactor = {1.0/1.0, 1.0/255, 1.0/65025.0, 1.0/16581375.0};
public final static double[] ogb = {65536.0 / 16777215.0, 256.0/16777215.0};
public final static double skmask = 1.0/256.0; 
public final static double sknormal = 256.0/255.0;

/////////////////////////// dot() / 255.0

//----------IMPL1
int skfloatToARGB32(double value) {
  double[] rgba = {
    skefactor[0] * value,
    skefactor[1] * value,
    skefactor[2] * value,
...
double skARGB32Tofloat(int argb) {
  double[] argbArray = getRGBA(argb);
  
  return dot(argbArray, skdfactor);
}

//------------------IMPL1
int skfloatToARGB24(double value){
  double[] rgb = {
    skefactor[0] * value,
    skefactor[1] * value,
    skefactor[2] * value
...
double skARGB24Tofloat(int argb) {
  double[] skdfactorRGB = {skdfactor[0], skdfactor[1], skdfactor[2]};
  double[] argbArray = getRGBA(argb);
...
//----------------------------IMPL2
int sk2floatToARGB24(double value){
  //avoid precision error
  double[] units = {value, value, value};
...
double sk2ARGB24Tofloat(int argb) {
  double[] skdfactorRGB = {65536.0/65793.0, 256.0/65793.0, 1.0/65793.0};
  double[] argbArray = getRGBA(argb);
...
//----------IMPL1
int skfloatToARGB16(double value) {
  double[] rgba = {
    skefactor[0] * value,
    skefactor[1] * value,
    //skefactor[2] * value,
...
double skARGB16Tofloat(int argb) {
  double[] argbArray = getRGBA(argb);
